...
const Hero = () => {
  ...
  return (
    ...
    >
      <div 
        className="absolute inset-0 -z-10 bg-gradient-to-b from-olive-50 to-cream opacity-70"
        aria-hidden="true"
      />
      <div 
        className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-cream to-transparent -z-10"
        aria-hidden="true"
      />
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 w-full">
        <div className="flex flex-col lg:w-1/2 space-y-6">
          ...
          >
            Pure <span className="text-gradient">Natural</span> Olive Oil From The Heart of Nature
          </h1>
          ...
          >
            Experience the essence of tradition and quality in every drop of our cold-pressed extra virgin olive oil.
          </p>
          
          <div className="flex items-center gap-4 pt-4">
            <a 
              href="#product" 
              className="btn-hover text-white px-6 py-3 rounded-full font-medium bg-olive-700 hover:bg-olive-800 shadow-lg shadow-olive-700/20 transition-all duration-300"
            >
              Explore Product
            </a>
            <a 
              href="#benefits" 
              className="text-olive-800 font-medium hover:text-olive-600 transition-colors"
            >
              Learn More
            </a>
          </div>
